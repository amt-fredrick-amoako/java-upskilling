package intermediate.labOne.dataStructures.bst;
...
public class BinarySearchTree {
    ...
    public void depthFirstTraversal() {
        ...
        Consumer<Integer> checker = num -> {};
        Consumer<Integer> checker2 = num -> {};
    }
    ...
    public static void check(Consumer<Integer> checker){
        checker.accept(0);
    }
}